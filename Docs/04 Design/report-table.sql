...
-- 标准时间表
drop table if report_standard_time;
...
-- 标准时间表子表
drop table if report_standard_time_item;
...
comment on column report_standard_work.first_standard_work_name is '首个标准工数title';
...
-- 标准时间表子表
drop table if report_standard_work_item;
