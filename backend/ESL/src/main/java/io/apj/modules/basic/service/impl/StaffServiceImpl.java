...
public class StaffServiceImpl extends ServiceImpl<StaffDao, StaffEntity> implements StaffService {
    ...
    public PageUtils queryPage(Map<String, Object> params) throws ParseException {
        ...
        Wrapper<StaffEntity> entityWrapper = new EntityWrapper<StaffEntity>().isNull("delete_at")
                ...
                .like(StringUtils.isNotEmpty((CharSequence) params.get("jobNumber")), "job_number",
                        (String) params.get("jobNumber"))
//                .like(StringUtils.isNotEmpty((CharSequence) params.get("employmentDate")), "employment_date",
//                        (String) params.get("employmentDate"))
        ...
        if (StringUtils.isNotEmpty((CharSequence) params.get("employmentDate"))) {
            SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");//注意月份是MM
            Date date = simpleDateFormat.parse((String) params.get("employmentDate"));
            entityWrapper.eq("employment_date",date);
        }
