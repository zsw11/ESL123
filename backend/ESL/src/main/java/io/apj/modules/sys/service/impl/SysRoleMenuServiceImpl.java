...
import io.apj.modules.sys.dao.SysRoleMenuDao;
import io.apj.modules.sys.entity.SysRoleMenuEntity;
...
public class SysRoleMenuServiceImpl extends ServiceImpl<SysRoleMenuDao, SysRoleMenuEntity> implements SysRoleMenuService {
	...
	@Override
	public List<SysMenuEntityVo> queryMenuVoList(Long roleId) {
		List<SysMenuEntityVo> list = new ArrayList<>();
 		for(Long id : baseMapper.queryMenuIdList(roleId)) {
			list.add(SysMenuEntityVo.makeVo(sysMenuService.selectById(id)));
		}
		return list;
	}
