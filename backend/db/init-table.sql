...
-- 报表和部门关系
drop table if exists report_dept_rela;
CREATE TABLE report_dept_rela (
  id serial PRIMARY KEY,
  report_id integer,
  dept_id integer,
  create_by integer,
...
comment on table report_dept_rela is '报表部门关系';
comment on column report_dept_rela.report_id is '报表ID';
comment on column report_dept_rela.dept_id is '部门ID';
CREATE UNIQUE INDEX report_dept_rela_uniq ON report_dept_rela (report_id,dept_id) WHERE delete_at IS NULL;
comment on column report_dept_rela.create_by is '创建者ID';
comment on column report_dept_rela.create_at is '创建时间';
comment on column report_dept_rela.update_by is '更新者ID';
...
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (2, 1, 'P制造中心', 0, 0, 'PMC', 'center', NULL, NULL, 3, '2019-12-15 21:09:11.021', NULL, '2019-12-15 21:09:11.021', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (4, 2, '完成品制造部', 0, 0, 'P-01', 'dept', NULL, NULL, 3, '2019-12-15 21:10:59', NULL, '2019-12-15 21:10:59', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (3, 1, 'VP制造中心', 1, 0, 'VPMC', 'center', NULL, NULL, 3, '2019-12-15 21:09:54.219', 3, '2019-12-15 21:14:08.007', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (5, 3, '组立技术', 1, 0, 'VP-01', 'dept', NULL, NULL, 3, '2019-12-15 21:14:43.254', NULL, '2019-12-15 21:14:43.254', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (6, 2, '要素', 2, 0, 'P-02', 'dept', NULL, NULL, 3, '2019-12-15 21:15:04.395', NULL, '2019-12-15 21:15:04.395', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (7, 2, '效率化投进部', 1, 0, 'VP-01', 'dept', NULL, NULL, 3, '2019-12-15 21:14:43.254', NULL, '2019-12-15 21:14:43.254', NULL);
INSERT INTO "public"."sys_dept"("id", "parent_id", "name", "order_num", "del_flag", "dept_code", "dept_type", "dept_level", "stlst", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (8, 2, '安全基盘管理部', 2, 0, 'P-02', 'dept', NULL, NULL, 3, '2019-12-15 21:15:04.395', NULL, '2019-12-15 21:15:04.395', NULL);
...
INSERT INTO "public"."sys_menu"("id", "parent_id", "name", "url", "perms", "type", "icon", "order_num", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (563, 506, '人机联合表', 'report/reportmanmachinecombination', NULL, 1, 'config', 11, NULL, '2019-11-26 13:52:46.527628', NULL, NULL, NULL);
INSERT INTO "public"."sys_menu"("id", "parent_id", "name", "url", "perms", "type", "icon", "order_num", "create_by", "create_at", "update_by", "update_at", "delete_at") VALUES (564, 563, '查看', NULL, 'report:reportmanmachinecombination:list,report:reportmanmachinecombination:detail', 2, NULL, 6, NULL, '2019-11-26 13:52:46.529281', NULL, NULL, NULL);
