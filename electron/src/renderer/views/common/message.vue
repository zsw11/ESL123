<template>
  <el-dialog :title="'未读消息信息'" :append-to-body="true" :visible.sync="visible">
    <el-form :model="dataForm" ref="dataForm" label-width="100px">
      <el-table :data="dataList" style="width: 100%;">
        ...
        <el-table-column prop="createTime" header-align="center" align="center" label="时间">
          <template
            slot-scope="scope"
          >{{ scope.row.createdAt ? day(scope.row.createdAt).format('YYYY-MM-DD') : ''}}</template>
        </el-table-column>
      </el-table>
    </el-form>
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="messageReadHadle()">设为已读</el-button>
      <el-button type="primary" @click="messageView()">消息中心</el-button>
