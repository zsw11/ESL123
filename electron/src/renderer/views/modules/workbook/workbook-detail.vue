        ...
        attributes: [
          {
            ...
            children: [
              ...
              {code: 'a0null', name: 'A', type: 'string', required: true},
              {code: 'b0', name: 'B', type: 'string', required: true},
              {code: 'b0null', name: 'B', type: 'string', required: true},
              {code: 'g0', name: 'G', type: 'string', required: true},
              {code: 'g0null', name: 'G', type: 'string', required: true},
              {code: 'a1', name: 'A', type: 'string', required: true},
              {code: 'a1null', name: 'A', type: 'string', required: true},
              {code: 'b1', name: 'B', type: 'string', required: true},
              {code: 'b1null', name: 'B', type: 'string', required: true},
              {code: 'p0', name: 'P', type: 'string', required: true},
              {code: 'p0null', name: 'P', type: 'string', required: true},
              {code: 'm0', name: 'M', type: 'string', required: true},
              {code: 'm0null', name: 'M', type: 'string', required: true},
              {code: 'x0', name: 'X', type: 'string', required: true},
              {code: 'x0null', name: 'X', type: 'string', required: true},
              {code: 'i0', name: 'I', type: 'string', required: true},
              {code: 'i0null', name: 'I', type: 'string', required: true},
              {code: 'a2', name: 'A', type: 'string', required: true},
              {code: 'a2null', name: 'A', type: 'string', required: true},
              {code: 'b2', name: 'B', type: 'string', required: true},
              {code: 'b2null', name: 'B', type: 'string', required: true},
              {code: 'p1', name: 'P', type: 'string', required: true},
              {code: 'p1null', name: 'P', type: 'string', required: true},
              {code: 'a3', name: 'A', type: 'string', required: true},
              {code: 'a3null', name: 'A', type: 'string', required: true},
              {code: 'tool', name: 'Tool', type: 'string', required: true},
              {code: 'a4', name: 'A', type: 'string', required: true},
              {code: 'a4null', name: 'A', type: 'string', required: true},
              {code: 'b3', name: 'B', type: 'string', required: true},
              {code: 'b3null', name: 'B', type: 'string', required: true},
              {code: 'p2', name: 'P', type: 'string', required: true},
              {code: 'p2null', name: 'P', type: 'string', required: true},
