  ...
  <div class="gen-list-page">
    <el-card class="filter-card with-title">
      ...
      <el-form :inline="true" :model="listQuery" @keyup.enter.native="getDataList()">
        ...
        <el-form-item :label="'关键词ID'" prop="operationId" >
          <el-input-number v-model="listQuery.operationId"  clearable></el-input-number>
        </el-form-item>
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        <div class="card-title">masterData</div>
        <div class="buttons">
          <el-button v-if="isAuth('masterData:deptoperationrela:create')" type="primary" @click="addOrUpdateHandle()">新增</el-button>

          <el-button v-if="isAuth('masterData:deptoperationrela:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
        </div>
      </div>
      <el-table
        :data="dataList"
        ...
        <el-table-column align="center" prop="operationId" label="关键词ID" >
          <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="'操作'" width="230" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button v-if="isAuth('masterData:deptoperationrela:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
            <el-button v-if="isAuth('masterData:deptoperationrela:delete')" size="mini" type="text" @click="deleteHandle(scope.row)">删除</el-button>
          </template>
        </el-table-column>
...
<script>
import { listDeptOperationRela, deleteDeptOperationRela } from '@/api/deptOperationRela'
export default {
  name: 'deptOperationRelaList',
  data () {
    return {
      dataButton: 'list',
      listQuery: {
  ...
  methods: {
    ...
    getDataList (pageNo) {
      ...
      listDeptOperationRela(Object.assign(
        {
          page: this.pageNo,
          limit: this.pageSize
        },
    ...
    addOrUpdateHandle (id) {
      this.$nextTick(() => {
        this.$router.push({ path: id ? `/edit-deptoperationrela/${id}` : '/add-deptoperationrela' })
      })
    },
    // 删除数据
    deleteHandle (row) {
      ...
      this.$confirm('此操作将删除数据, 是否继续?', '提示', {
        ...
        deleteDeptOperationRela(ids).then(() => {
          this.$notify({
            title: '成功',
            message: '删除成功',
            type: 'success',
