      ...
      <el-row :gutter="10">
        <el-col :span="10">
          <el-form-item :label="'WS时间'" prop="wsTime">
            <el-date-picker style="width: 100%" v-model="dataForm.wsTime"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="10" :offset="2">
          <el-form-item :label="'ES时间'" prop="esTime">
            <el-date-picker style="width: 100%" v-model="dataForm.esTime"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="10">
        <el-col :span="10">
          <el-form-item :label="'AMP时间'" prop="ampTime">
            <el-date-picker style="width: 100%" v-model="dataForm.ampTime"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="10" :offset="2">
          <el-form-item :label="'MP时间'" prop="mpTime">
            <el-date-picker style="width: 100%" v-model="dataForm.mpTime"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  name: "modelworkstationrela-maintain",
  data() {
    return {
      title: null,
      flag: false,
