<template>
  <div class="gen-list-page">
    <el-card class="filter-card with-title">
      ...
      <el-form :inline="true" :model="listQuery" @keyup.enter.native="getDataList()">
        ...
        <el-form-item :label="'是否通用'" prop="isCommon" >
          <el-switch v-model="listQuery.isCommon"></el-switch>
        </el-form-item>
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        <div class="card-title">部品</div>
        <div class="buttons">
          <el-button v-if="isAuth('masterData:part:create')" type="primary" @click="addOrUpdateHandle()">新增</el-button>

          <el-button v-if="isAuth('masterData:part:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
        </div>
      </div>
      <el-table
        :data="dataList"
      ...
      <el-table-column align="center" :label="'操作'" width="230" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button v-if="isAuth('masterData:part:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
