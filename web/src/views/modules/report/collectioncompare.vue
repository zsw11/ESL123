  ...
  <div class="gen-list-page">
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        ...
        <div class="buttons">
          <el-button
            v-if="isAuth('report:collectioncompare:create')"
            type="primary"
            @click="addOrUpdateHandle()"
          >新增</el-button>

          <el-button
            v-if="isAuth('report:collectioncompare:delete')"
            type="danger"
            @click="deleteHandle()"
      ...
      >
        ...
        <el-table-column align="center" prop="lastVersionName" label="上一版本名称">
          <template slot-scope="scope">
            <span>{{scope.row.lastVersionName }}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" prop="current_version_name" label="当前版本名称">
          <template slot-scope="scope">
        ...
        >
          <template slot-scope="scope">
            <el-button
              v-if="isAuth('report:collectioncompare:update')"
              type="text"
              size="small"
