  ...
  <div class="gen-list-page">
    <el-card class="filter-card with-title">
      ...
      <el-form :inline="true" :model="listQuery" @keyup.enter.native="getDataList()">
        ...
        <el-form-item :label="'报表意见ID'" prop="reportApproveId">
          <el-input-number v-model="listQuery.reportApproveId" clearable></el-input-number>
        </el-form-item>
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        ...
        <div class="buttons">
          <el-button
            v-if="isAuth('report:reportapprovehistory:create')"
            type="primary"
            @click="addOrUpdateHandle()"
          >新增</el-button>

          <el-button
            v-if="isAuth('report:reportapprovehistory:delete')"
            type="danger"
            @click="deleteHandle()"
      ...
      >
        ...
        <el-table-column align="center" prop="reportApproveId" label="报表意见ID">
          <template slot-scope="scope">
        ...
        >
          <template slot-scope="scope">
            <el-button
              v-if="isAuth('report:reportapprovehistory:update')"
              type="text"
              size="small"
