  ...
  <div class="gen-list-page">
    <el-card class="filter-card with-title">
      ...
      <el-form :inline="true" :model="listQuery" @keyup.enter.native="getDataList()">
        ...
        <el-form-item :label="'津贴'" prop="allowanceRate">
          <el-input-number v-model="listQuery.allowanceRate" clearable></el-input-number>
        </el-form-item>
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        ...
        <div class="buttons">
          <el-button
            v-if="isAuth('report:reporttotal:create')"
            type="primary"
            @click="addOrUpdateHandle()"
          >新增</el-button>

          <el-button
            v-if="isAuth('report:reporttotal:delete')"
            type="danger"
            @click="deleteHandle()"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              v-if="isAuth('report:reporttotal:update')"
              type="text"
              size="small"
