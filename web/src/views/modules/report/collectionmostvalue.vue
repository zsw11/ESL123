  ...
  <div class="gen-list-page">
    ...
    <el-card class="with-title">
      <div slot="header" class="clearfix">
        ...
        <div class="buttons">
          <el-button
            v-if="isAuth('report:collectionmostvalue:create')"
            type="primary"
            @click="addOrUpdateHandle()"
          >新增</el-button>

          <el-button
            v-if="isAuth('report:collectionmostvalue:delete')"
            type="danger"
            @click="deleteHandle()"
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button
              v-if="isAuth('report:collectionmostvalue:update')"
              type="text"
              size="small"
  ...
  methods: {
    ...
    deleteHandle (row) {
      ...
      this.$confirm('此操作将删除数据, 是否继续?', '提示', {
        ...
        deleteCollectionMostValue(ids).then(() => {
          this.$notify({
            title: '成功',
            message: '删除成功',
            type: 'success',
